...
word_rows = [
    ...
    ("V区变量", "16位有符号二进制", 8, 1, "只读", "VW8_RoundCount", "实验总换水次数目标"),
    ...
    ("V区变量", "32位浮点数", 440, 1, "只读", "VD_Dosed_Volume_Total", "本次实验累计加药量(uL)"),
    ("V区变量", "32位浮点数", 452, 1, "读写", "VD_ManualDose_Target", "手动注射泵总加药量(uL)"),
